...
DATE: ".date('Y-m-d H:i:s')."<br />
LOCATION: visit page";
            $subject = 'szarazferenc.hu-ról érkezett, authorizált oldallátogatás -';
            $from = "me@szarazferenc.hu";
            $fromname = "page visit";
        callsendmsg($subject, $msg, $from, $fromname, $test);        
    }
    elseif($_GET['do']=='visitmainpage'){
        $msg="
IDENTITY NAME: ".$idname."<br />
IDENTITY KEY: ".$idkey."<br />
IP: ".$_SERVER['REMOTE_ADDR']."<br />
HOST: ".$hostname."<br />
DATE: ".date('Y-m-d H:i:s')."<br />
LOCATION: visit mainpage";
            $subject = 'szarazferenc.hu-ról érkezett, main oldallátogatás -';
            $from = "me@szarazferenc.hu";
            $fromname = "main page visit";
        callsendmsg($subject, $msg, $from, $fromname, $test);        
    }
    elseif($_GET['do']=='visitideaspage'){
        $msg="
IDENTITY NAME: ".$idname."<br />
IDENTITY KEY: ".$idkey."<br />
IP: ".$_SERVER['REMOTE_ADDR']."<br />
HOST: ".$hostname."<br />
DATE: ".date('Y-m-d H:i:s')."<br />
LOCATION: visit ideas page";
            $subject = 'ideas.szarazferenc.hu-ról érkezett, main oldallátogatás -';
            $from = "me@szarazferenc.hu";
            $fromname = "ideas page visit";
        callsendmsg($subject, $msg, $from, $fromname, $test);        
    }
